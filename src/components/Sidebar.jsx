          ...
          <Toolbar />
            <List>
              <ListItem className={styles.logo}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 479.1 521.61" width="40" height="40" fill="#fff"><defs>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 993.38 225.48" width="100" fill="#fff"><defs>
                {/* <style>.cls-1{fill=#fff;}</style> */}
